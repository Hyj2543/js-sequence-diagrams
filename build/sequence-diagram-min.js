(function() {
    ...
    Diagram.prototype.getActor = function(alias) {
        ...
        var message = new Diagram.Message(alias);
    ...
    var grammar = function() {
        var parser = {
            ...
            productions_: [ 0, [ 3, 2 ], [ 4, 0 ], [ 4, 2 ], [ 6, 1 ], [ 6, 1 ], [ 7, 2 ], [ 7, 1 ], [ 7, 1 ], [ 7, 2 ], [ 12, 4 ], [ 12, 4 ], [ 18, 1 ], [ 18, 3 ], [ 16, 1 ], [ 16, 1 ], [ 11, 4 ], [ 10, 1 ], [ 10, 2 ], [ 22, 2 ], [ 22, 1 ], [ 25, 1 ], [ 25, 1 ], [ 26, 1 ], [ 26, 1 ], [ 14, 1 ], [ 14, 2 ], [ 24, 1 ] ],
            performAction: function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
                ...
                switch (yystate) {
                  ...
                  case 25:
                    this.$ = new Diagram.Message($$[$0].substring(1).trim().replace(/\\n/gm, "\n"));
                    break;
                  ...
                  case 27:
                    this.$ = new Diagram.Attributes($$[$0].substring(1, $$[$0].length - 1));
                    break;
                }
            },
            table: [ {
...
(function() {
    ...
    Raphael.fn.wobble = function(x1, y1, x2, y2) {
        ...
        var r1 = Math.random();
        var r2 = Math.random();
        var xfactor = Math.random() > .5 ? wobble : -wobble;
        var yfactor = Math.random() > .5 ? wobble : -wobble;
        var p1 = {
